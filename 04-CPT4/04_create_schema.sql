...
*  Usage: 
*  echo "EXIT" | sqlplus System/<SystemPass>@DEV_VOCAB @04_create_schema.sql <CPT_User> <Pass_CPT_Realise_User>
*
******************************************************************************/



SPOOL 04_create_schema_&1..log;

--/*

CREATE USER &1. --CPT_20120131
 IDENTIFIED BY &2. --<password>
 DEFAULT TABLESPACE USERS
 TEMPORARY TABLESPACE TEMP
 PROFILE DEFAULT
 ACCOUNT UNLOCK;
 -- 1 Role for CPT_20120131
 GRANT CONNECT TO &1. --CPT_20120131;
 ALTER USER &1. DEFAULT ROLE ALL;
 -- 5 System Privileges for CPT_20120131
 GRANT CREATE PROCEDURE TO &1.;
 GRANT CREATE SEQUENCE TO &1.;
 GRANT CREATE ANY INDEX TO &1.;
 GRANT CREATE DATABASE LINK TO &1.;
 GRANT CREATE TABLE TO &1.;
 -- 1 Tablespace Quotas for CPT_20120131
 ALTER USER &1. QUOTA UNLIMITED ON USERS;
--*/ 

 -- 6 Dev Privileges for CPT_20120131
 ...
 /*
  -- 5 Prd Privileges for CPT_20120131
...
CREATE INDEX &1..XAN_2cd ON &1..CONCEPT_ANCESTOR_STAGE
(DESCENDANT_CONCEPT_ID, ANCESTOR_CONCEPT_ID)
;
