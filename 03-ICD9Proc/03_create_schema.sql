...
*  Usage: 
*  echo "EXIT" | sqlplus System/<SystemPass>@DEV_VOCAB @03_create_schema.sql <ICD9PR_User> <Pass_ICD9PR_Realise_User>
*
******************************************************************************/
...
CREATE USER &1. --ICD9PR_20120131
 IDENTIFIED BY &2. --<password>
 DEFAULT TABLESPACE USERS
 TEMPORARY TABLESPACE TEMP
 PROFILE DEFAULT
 ACCOUNT UNLOCK;
 -- 1 Role for ICD9PR_20120131
 GRANT CONNECT TO &1. --ICD9PR_20120131;
 ALTER USER &1. DEFAULT ROLE ALL;
 -- 5 System Privileges for ICD9PR_20120131
 GRANT CREATE PROCEDURE TO &1.;
 GRANT CREATE SEQUENCE TO &1.;
 GRANT CREATE ANY INDEX TO &1.;
 GRANT CREATE DATABASE LINK TO &1.;
 GRANT CREATE TABLE TO &1.;
 -- 1 Tablespace Quotas for ICD9PR_20120131
 ALTER USER &1. QUOTA UNLIMITED ON USERS;
 
 -- 6 Dev Privileges for ICD9PR_20120131
 ...
 /*
  -- 5 Prd Privileges for ICD9PR_20120131
...
---------------------
--1.4.3 Filter out extraneous copyright messages in the data file. Create consistent file names that are not date dependent.

--    $ grep     'All rights reserved.'  sct2_Description_Full-en_INT_20120131.txt  > sct2_Description_Full-en_INT.Copyright

--    $ grep -v 'All rights reserved.'  sct2_Description_Full-en_INT_20120131.txt  > sct2_Description_Full-en_INT.txt

--    $ mv  sct2_Relationship_Full_INT_20120131.txt   sct2_Relationship_Full_INT.txt 

--"CMS30_DESC_LONG_DX 080612.txt" LAST VERS
CREATE TABLE &1..CMS_DESC_LONG_SG
(
