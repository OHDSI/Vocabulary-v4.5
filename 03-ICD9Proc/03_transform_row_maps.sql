...
*
******************************************************************************/
SPOOL 03_transform_row_maps.log
-- . 
...
--/*
INSERT INTO SOURCE_TO_CONCEPT_MAP_STAGE( --03-->03
...
, 03 AS TARGET_CONCEPT_TYPE_ID
, 03 AS SOURCE_CONCEPT_TYPE_ID
, 'Y' AS PRIMARY_MAP
, 0 AS ISHANDMADE
     FROM concept_STAGE Co1
     , DEV.concept dv
WHERE     
  Co1.VOCABULARY_ID = 03
  AND DV.VOCABULARY_ID = 03
