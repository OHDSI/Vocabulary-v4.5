...
*  Usage: 
*  echo "EXIT" | sqlplus System/<SystemPass>@DEV_VOCAB @02_create_schema.sql <ICD9CM_User> <Pass_ICD9CM_Realise_User>
*
******************************************************************************/



SPOOL 02_create_schema_&1..log;

CREATE USER &1. --ICD9CM_20120131
 IDENTIFIED BY &2. --<password>
 DEFAULT TABLESPACE USERS
 TEMPORARY TABLESPACE TEMP
 PROFILE DEFAULT
 ACCOUNT UNLOCK;
 -- 1 Role for ICD9CM_20120131
 GRANT CONNECT TO &1. --ICD9CM_20120131;
 ALTER USER &1. DEFAULT ROLE ALL;
 -- 5 System Privileges for ICD9CM_20120131
 GRANT CREATE PROCEDURE TO &1.;
 GRANT CREATE SEQUENCE TO &1.;
 GRANT CREATE ANY INDEX TO &1.;
 GRANT CREATE DATABASE LINK TO &1.;
 GRANT CREATE TABLE TO &1.;
 -- 1 Tablespace Quotas for ICD9CM_20120131
 ALTER USER &1. QUOTA UNLIMITED ON USERS;
 
 -- 6 Dev Privileges for ICD9CM_20120131
 ...
 /*
  -- 5 Prd Privileges for ICD9CM_20120131
...
---------------------
--"CMS30_DESC_LONG_DX 080612.txt" LAST VERS
CREATE TABLE &1..CMS_DESC_LONG_DX
(
...
CREATE TABLE &1..RFMLISR0_ICD9CM_SEARCH
 (SEARCH_ICD9CM VARCHAR2(10) NOT NULL
 ,RELATED_DXID NUMBER(8) NOT NULL
 ,FML_CLIN_CODE VARCHAR2(2) NOT NULL
 ,FML_NAV_CODE VARCHAR2(2) NOT NULL
 );
 
CREATE INDEX &1..RFMLISR0_NX3 ON &1..RFMLISR0_ICD9CM_SEARCH
 (RELATED_DXID);

CREATE INDEX &1..RFMLISR0_NX1 ON &1..RFMLISR0_ICD9CM_SEARCH
 (FML_CLIN_CODE);

CREATE INDEX &1..RFMLISR0_NX2 ON &1..RFMLISR0_ICD9CM_SEARCH
 (FML_NAV_CODE); 

CREATE TABLE &1..RFMLDX0_DXID
 (DXID NUMBER(8) NOT NULL
...
CREATE INDEX &1..RFMLDX0_NX3 ON &1..RFMLDX0_DXID
 (DXID_DISEASE_DURATION_CD);

CREATE INDEX &1..RFMLDX0_NX2 ON &1..RFMLDX0_DXID
 (FDBDX);

CREATE INDEX &1..RFMLDX0_NX1 ON &1..RFMLDX0_DXID
 (DXID_STATUS); 


CREATE TABLE &1..A_MANUAL_MAPPS_02_01_LIHGT
(
  CD                VARCHAR2(256 BYTE),
  C01#CONCEPT_CODE  VARCHAR2(256 BYTE),
  TYPE              VARCHAR2(256 BYTE)
);

CREATE TABLE &1..RFMLISR1_ICD_SEARCH  (SEARCH_ICD_CD VARCHAR(10) NOT NULL,ICD_CD_TYPE VARCHAR(2) NOT NULL,RELATED_DXID NUMERIC(8) NOT NULL,FML_CLIN_CODE VARCHAR(2) NOT NULL,FML_NAV_CODE VARCHAR(2) NOT NULL) ;

CREATE INDEX &1..RFMLISR1_1 ON &1..RFMLISR1_ICD_SEARCH
 (SEARCH_ICD9CM);

CREATE INDEX &1..RFMLISR1_2 ON &1..RFMLISR1_ICD_SEARCH
 (F_CODE);

CREATE INDEX &1..RFMLISR1_3 ON &1..RFMLISR1_ICD_SEARCH
 (RELATED_DXID);

CREATE INDEX &1..RFMLISR1_4 ON &1..RFMLISR1_ICD_SEARCH
 (FML_CLIN_CODE);

CREATE INDEX &1..RFMLISR1_5 ON &1..RFMLISR1_ICD_SEARCH
 (FML_NAV_CODE);
